...
* Minor phrasing changes in `alt_form` data.
...
The three pilot datasets used for the last section of the paper (to showcase remove degeneracy) is included directly in `data`.
